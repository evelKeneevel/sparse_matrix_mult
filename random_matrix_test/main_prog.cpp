...
int pak_t = 0, pak_th_t = 0, pak_gpu_t = 0, coo_t = 0, coo_th_t = 0, coo_gpu_t = 0, csr_t = 0, csr_th_t = 0,
        csr_gpu_t = 0, dia_t = 0, dia_th_t = 0, dia_gpu_t = 0, ell_t = 0, ell_th_t = 0, ell_gpu_t = 0;
